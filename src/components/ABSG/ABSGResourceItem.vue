  ...
  <div class="sspm-container">
    <div class="flex gap-4 md:gap-8 flex-col md:flex-row w-full">
      <div class="flex flex-col items-center md:items-start">
        <div :class="`resource-item-${resource.kind} flex flex-col gap-5`">
...
import ResourceCredits from '@/components/ABSG/ABSGResourceCredits.vue'
import TableOfContents from '@/components/ABSG/ABSGTableOfContents.vue'
import { ResourceTitleTextStyle, ResourceSubtitleTextStyle, ResourceDescriptionTextStyle } from "@/components/Resources/Style/ResourceTextStyle"
...
.resource-item {
  &-title {
    @apply text-3xl text-center md:text-start text-sspm-accent-800;
    &-plain {
      @apply font-bold;
    }
  }
  &-subtitle {
    @apply text-sm text-gray-500 text-center md:text-start;
  }

  &-description {
    @apply text-center md:text-start text-gray-600;
  }
